...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"scripts/runQuery.js":[function(require,module,exports) {
"use strict";
...
function runQuery(url, query) {
  return fetch(url + "?query=" + encodeURIComponent(query) + "&format=json").then(function (res) {
    return res.json();
  }).then(function (data) {
...
var _getContinents = require("./getContinents.js");

var _runQuery = require("./runQuery.js");

var _dataOphalen = require("./dataOphalen.js");

function loopData(data) {
  return data.map(function (item) {
    return {
      category: "<".concat(item.category.value, ">"),
      categoryLabel: item.categoryLabel.value,
      countObj: item.choCount.value
    };
  }).reduce(function _callee(newData, currentItem) {
    var dataToReturn, continentenVoorCurrentItem;
    return regeneratorRuntime.async(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return regeneratorRuntime.awrap(newData);

          case 2:
            dataToReturn = _context.sent;
            _context.next = 5;
            return regeneratorRuntime.awrap((0, _runQuery.runQuery)(_dataOphalen.eindpoint, (0, _getContinents.getGeoQueryForCategory)(currentItem.category)).then(function (data) {
              return data.map(function (item) {
                return {
          ...
          case 5:
            continentenVoorCurrentItem = _context.sent;
...
},{"./getContinents.js":"scripts/getContinents.js","./runQuery.js":"scripts/runQuery.js","./dataOphalen.js":"scripts/dataOphalen.js"}],"scripts/helpers.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.color = exports.raduis = exports.height = exports.width = exports.barHeight = exports.verticalBarSpace = exports.svgWidth = exports.svgHeight = exports.marginBarChart = exports.svg = exports.pie = exports.arc = exports.margin = void 0;
//////////////////////// setup ////////////////////////
...
var margin = {
  ...
  left: 20
    ...
    raduis = width / 2; // arc generator

exports.raduis = raduis;
exports.height = height;
exports.width = width;
exports.margin = margin;
var arc = d3.arc().outerRadius(raduis - 10).innerRadius(raduis - 100);
exports.arc = arc;
var color = d3.scaleOrdinal(d3.schemePaired); // pie generator
...
exports.pie = pie;
var svg = d3.select("#dashboard").append("svg").attr("width", width).attr("height", height).attr("class", "pie-chart").attr("overflow", "visible").append("g").attr("transform", "translate(" + width / 2 + "," + height / 2 + ")"); // define the margin and the width and height for the bar-chart
...
exports.marginBarChart = marginBarChart;
var svgHeight = 380 - marginBarChart.right - marginBarChart.left;
exports.svgHeight = svgHeight;
var svgWidth = 500 - marginBarChart.top - marginBarChart.bottom;
exports.svgWidth = svgWidth;
var verticalBarSpace = 50;
exports.verticalBarSpace = verticalBarSpace;
var barHeight = 30; /////////////////////////// end setup ////////////////////////////////////

exports.barHeight = barHeight;
},{}],"scripts/updateBarChart.js":[function(require,module,exports) {
"use strict";
...
function updateBarChart(data, n, color) {
  ...
  var Yscale = d3.scaleLinear().domain([0, d3.max(data[0].continenten, function (d) {
    return d.aantalObjInGebied;
  })]).range([0, _helpers.svgHeight]); //update bars

  var bar = d3.selectAll(".bar").data(data[n].continenten);
  bar.enter().append("rect").merge(bar).style("fill", color).attr("class", "bar").transition().ease(d3.easeLinear).duration(500).attr("width", function (d) {
    return Yscale(d.aantalObjInGebied) + 1;
  });
  bar.exit().remove(); // update bar text (aantalobjecten)

  var barText = d3.selectAll(".bar-text").data(data[n].continenten);
  barText.enter().append("text").merge(barText).attr("class", "bar-text").text(function (d) {
    return d.aantalObjInGebied + " objecten";
  }).attr("x", function (d) {
    return Yscale(d.aantalObjInGebied) + 50;
  });
  barText.exit().remove(); // update label

  var barLabel = d3.selectAll(".bar-label").data(data[n].continenten);
  barLabel.enter().append("text").merge(barLabel).attr("class", "bar-label").text(function (d) {
    return d.gebiedLabel;
  }).transition().ease(d3.easeLinear).duration(200).attr("y", 220).style("font-size", "3").transition().ease(d3.easeLinear).duration(300).delay(function (d, i) {
    return i * 100 + _helpers.barHeight / 2;
  }).attr("y", function (d, i) {
...
exports.resetPieChart = resetPieChart;

var _helpers = require("./helpers.js");

function resetPieChart(data) {
  var resetPie = d3.pie().sort(null).value(function (d) {
    return d.countObj;
  });
  d3.selectAll("path").data(resetPie(data)).attr("d", _helpers.arc).style("fill", function (d) {
    return (0, _helpers.color)(d.data.categoryLabel);
  ...
  .transition().duration(1000).attrTween("d", function (d) {
    ...
    return function (t) {
      return (0, _helpers.arc)(interpolate(t));
    };
  }); // update title
...
},{"./helpers.js":"scripts/helpers.js"}],"scripts/pieTween.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.pieTween = pieTween;
...
function pieTween(b) {
  ...
  return function (t) {
    return (0, _helpers.arc)(i(t));
  };
}
},{"./helpers.js":"scripts/helpers.js"}],"scripts/makePieChart.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.makePieChart = makePieChart;

var _updateBarChart = require("./updateBarChart.js");

var _resetPieChart = require("./resetPieChart");

var _pieTween = require("./pieTween.js");
...
function makePieChart(data) {
  ...
  var g = _helpers.svg.selectAll(".arc").data((0, _helpers.pie)(data)).enter().append("g").attr("class", "arc").style("cursor", "pointer"); // append path to g(.arc)


  g.append("path").attr("d", _helpers.arc).style("fill", function (d) {
    return (0, _helpers.color)(d.data.categoryLabel);
  }).transition().ease(d3.easeLinear).duration(1000).attrTween("d", _pieTween.pieTween); //appen the text (labels)

  g.append("text").attr("transform", "translate(0, 30)").attr("class", "label").attr("text-anchor", "middle").attr("font-size", 10).attr("dy", ".35em").text(function (d) {
    return d.data.categoryLabel;
  }); // sum objecten in the midle of the donut-chart

  g.append("text").attr("class", "aantalObjecten").attr("text-anchor", "middle").attr("font-size", "28").attr("dy", ".35em").text(function (d) {
    return d.data.countObj;
  }); //add title

  _helpers.svg.append("text").attr("class", "pie-title").text("Totaal").attr("x", -25).attr("y", -240).style("font-size", "18"); // on click update bar-chart and reset the pie-cahrt


  d3.selectAll(".arc").on("click", function () {
    //console.dir(this)
    var categroieColor = this.childNodes[0].style.fill;
    var categorieNumber = this.__data__.index;
    (0, _updateBarChart.updateBarChart)(data, categorieNumber, categroieColor);
    (0, _resetPieChart.resetPieChart)(data);
  });
}
},{"./updateBarChart.js":"scripts/updateBarChart.js","./resetPieChart":"scripts/resetPieChart.js","./pieTween.js":"scripts/pieTween.js","./helpers.js":"scripts/helpers.js"}],"scripts/updatePieChart.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updatePieChart = updatePieChart;

var _helpers = require("./helpers.js");

function updatePieChart(data, continentNaam) {
  //update data
  var updatedPie = d3.pie().sort(null).value(function (d) {
    var filterDataOpcontinentNaam = d.continenten.filter(function (item) {
      return item.gebiedLabel == continentNaam;
    });
    var aantalObjectenPerContinent = filterDataOpcontinentNaam.map(function (item) {
      return item.aantalObjInGebied;
    });
    return aantalObjectenPerContinent[0];
  }); // update the paths

  d3.selectAll("path").data(updatedPie(data)).attr("d", _helpers.arc).style("fill", function (d) {
    return (0, _helpers.color)(d.data.categoryLabel);
  }) // this transition came from http://bl.ocks.org/dbuezas/9306799
  .transition().duration(1000).attrTween("d", function (d) {
    this._current = this._current || d;
  ...
  d3.selectAll(".aantalObjecten").text(function (d) {
    var filterDataOpcontinentNaam = d.data.continenten.filter(function (item) {
      return item.gebiedLabel == continentNaam;
    });
    var aantalObjectenPerContinent = filterDataOpcontinentNaam.map(function (item) {
      return item.aantalObjInGebied;
...
},{"./helpers.js":"scripts/helpers.js"}],"scripts/makeBarChart.js":[function(require,module,exports) {
"use strict";
...
var _updatePieChart = require("./updatePieChart.js");

function makeBarChart(data, n) {
  console.log(data); // define svg for barchart

  var svg2 = d3.select("#dashboard").append("svg").attr("width", _helpers.svgWidth).attr("height", _helpers.svgHeight).attr("overflow", "visible").attr("class", "bar-chart"); // genrate groups

  var g = svg2.selectAll(".group-bar").data(data[n].continenten).enter().append("g").attr("class", "group-bar").style("cursor", "pointer"); // make scale

  var Yscale = d3.scaleLinear().domain([0, d3.max(data[n].continenten, function (d) {
    return d.aantalObjInGebied;
  })]).range([0, _helpers.svgHeight]); // make bars

  d3.select(".group-bar").selectAll(".bar").data(data[n].continenten).enter();
  g.append("rect").attr("class", "bar").style("fill", "rgb(166, 206, 227)").attr("x", 25).attr("y", function (d, i) {
    return i * _helpers.verticalBarSpace;
  }).attr("height", _helpers.barHeight).transition().ease(d3.easeLinear).duration(800).attr("width", function (d) {
    return Yscale(d.aantalObjInGebied) + 1;
  }); //make tool tip with aantalopbjecten

  d3.select(".group-bar").selectAll(".bar-text").data(data[n].continenten).enter();
  g.append("text").attr("class", "bar-text").text(function (d) {
    return d.aantalObjInGebied + " objecten";
  }).attr("y", function (d, i) {
    return i * _helpers.verticalBarSpace + _helpers.barHeight / 2;
  }).transition().ease(d3.easeLinear).duration(800).attr("x", function (d) {
    return Yscale(d.aantalObjInGebied) + 50;
  }); // make labels

  d3.select(".group-bar").selectAll(".bar-label").data(data[n].continenten).enter();
  g.append("text").attr("class", "bar-label").attr("text-anchor", "end").text(function (d) {
    return d.gebiedLabel;
  ...
  d3.selectAll(".bar").on("click", function (d, i) {
    //console.dir(this)
    var continentNaam = this.__data__.gebiedLabel;
    (0, _updatePieChart.updatePieChart)(data, continentNaam);
  });
}
},{"./helpers.js":"scripts/helpers.js","./updatePieChart.js":"scripts/updatePieChart.js"}],"scripts/dataOphalen.js":[function(require,module,exports) {
"use strict";
...
exports.eindpoint = void 0;

var _runQuery = require("./runQuery.js");

var _transformData = require("./transformData.js");

var _makePieChart = require("./makePieChart.js");

var _makeBarChart = require("./makeBarChart.js");

var eindpoint = "https://api.data.netwerkdigitaalerfgoed.nl/datasets/ivo/NMVW/services/NMVW-22/sparql";
exports.eindpoint = eindpoint;
...
(0, _runQuery.runQuery)(eindpoint, categoryQuery).then(_transformData.loopData).then(function (prettyData) {
  (0, _makePieChart.makePieChart)(prettyData);
  (0, _makeBarChart.makeBarChart)(prettyData, 0);
});
},{"./runQuery.js":"scripts/runQuery.js","./transformData.js":"scripts/transformData.js","./makePieChart.js":"scripts/makePieChart.js","./makeBarChart.js":"scripts/makeBarChart.js"}],"../node_modules/core-js/modules/_global.js":[function(require,module,exports) {
...
},{"core-js/shim":"../node_modules/core-js/shim.js","regenerator-runtime/runtime":"../node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"../node_modules/core-js/fn/regexp/escape.js"}],"scripts/index.js":[function(require,module,exports) {
"use strict";
